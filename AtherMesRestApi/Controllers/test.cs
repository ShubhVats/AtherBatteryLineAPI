...
//                    //Update RejectionTable
//                    var batteryDetailsRejection = await _context.Quality_DHCRejection_WIPCommon.Where(a => a.BIN_Number.Equals(batteryDetails.BIN_Number) && (a.ParameterId.Equals(batteryDetails.ParameterId) || a.ParameterId.Equals("D1135") || a.ParameterId.Equals("D1136"))).ToListAsync();

//                    if (batteryDetailsRejection != null)
//                    {
//                        if (batteryDetailsRejection.Count > 0)
//                        {
//                            batteryDetailsRejection.ForEach(a => a.ParameterVal = batteryDetails.ParameterVal);
//                            batteryDetailsRejection.ForEach(a => a.OperatorRemark = batteryDetails.OperatorRemark);
//                            batteryDetailsRejection.ForEach(a => a.Category = batteryDetails.Category);
...
//                        if (closeFlag == 0 && batteryDetails.Status == "7")
//                        {
...
//            }
//        }
//        private void CLOSE_JIRA_TICKETS(BatteryDetails batteryDetails, List<JIRA_Send_Data> tickets)
//        {
